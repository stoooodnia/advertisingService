<template>
    <div class="h-screen w-[240px] bg-my-black">
        <div class="text-white flex items-center h-[82px] pt-2 pl-[30px]">
            <svg width="150" height="60" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill-rule="evenodd" clip-rule="evenodd" fill="#FFFFFF" d="M472,480h-79.991c-19.375,0-35.523-13.758-39.211-32.04
